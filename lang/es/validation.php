...
return [
    ...
    | usados por la clase de validación. Algunas de estas reglas tienen
    | múltiples versiones como las reglas de tamaño. Siéntase libre de
...
| marcador de posición del atributo por algo más comprensible, como 
